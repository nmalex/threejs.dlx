...
#define MAXVER_INTERNALNAME "MAXScriptIntervalArray\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "IntervalArray.dlx\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "MaxScript Interval Array (dlx)\0"//should  be overidden on a per-dll level
